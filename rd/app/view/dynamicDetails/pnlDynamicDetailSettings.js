Ext.define('Rd.view.dynamicDetails.pnlDynamicDetailSettings', {
    ...
    initComponent: function(){
        ...
        var thank_you = '/cake3/rd_cake/dynamic-details/thank-you.json';       
        var cntPrelogin = {
            xtype   : 'panel',
            itemId  : 'cntPrelogin',
            hidden  : true,
            ...
            items   : [
                {
			        xtype       : 'textfield',
			        fieldLabel  : 'Pre-Login URL',
			        itemId      : 'txtPreloginUrl',
			        name        : "prelogin_url",
			        disabled    : true,
			        hidden      : true,
			        allowBlank  : false,
			    ...
			    {
                    xtype       : 'displayfield',
                    fieldLabel  : 'Return URL',
                    itemId      : 'txtReturnUrl',
                    name        : "prelogin_return_url",
                    disabled    : true,
			        hidden      : true,
                    value       : proto+"//"+host+thank_you
                },
			    { 
					xtype       : 'cmbExpire', 
					labelClsExtra : 'lblRdReq',
					allowBlank  : false,
					itemId      : 'cmbPreloginExpire',
				    disabled    : true,
			        hidden      : true
				}
            ]
                        ...
                        items   : [
							...
							{ 
                                ...
                                items       : [
                                    {
								        xtype       : 'checkbox',      
								        fieldLabel  : 'Pre-Login Redirect',
								        itemId      : 'chkPrelogin',
								        name        : 'prelogin_check',
								        inputValue  : 'prelogin_check',
								        checked     : false,
								        labelClsExtra: 'lblRdReq',
								        listeners   : {
                                            change : 'chkPreloginChange'
                                        }   
								    },
								    cntPrelogin,
									{
