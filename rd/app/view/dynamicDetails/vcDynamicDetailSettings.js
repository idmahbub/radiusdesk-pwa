Ext.define('Rd.view.dynamicDetails.vcDynamicDetailSettings', {
    ...
    chkPreloginChange: function(chk){
        var me          = this;
        var form        = chk.up('form');
        var disabled    = true;
        if(chk.getValue()){   
        ...
        form.down('#cntPrelogin').setHidden(disabled);
        form.down('#cntPrelogin').setDisabled(disabled);     
        form.down('#txtPreloginUrl').setDisabled(disabled);
        form.down('#txtPreloginUrl').setHidden(disabled);
        form.down('#txtReturnUrl').setDisabled(disabled);
        form.down('#txtReturnUrl').setHidden(disabled);
        form.down('#cmbPreloginExpire').setDisabled(disabled);
        form.down('#cmbPreloginExpire').setHidden(disabled);
    },
