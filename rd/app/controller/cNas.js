/*
 * Port to cake3: JT 09/15/18 working
*/
Ext.define('Rd.controller.cNas', {
    ...
    views:  [
        'nas.gridNas','nas.winNasAddWizard','nas.gridRealmsForNasOwner', 
    ...
    stores: ['sNas','sDynamicAttributes','sAccessProvidersTree', 'sNasTypes'],
    models: ['mNas','mRealmForNasOwner','mApRealms', 'mDynamicAttribute','mGenericList','mAccessProviderTree', 
                 'mNasType', 'mNaState', 'mAction','mUserStat' ],
    selectedRecord: null,
    config: {
    ...
    select: function(grid,record){
        var me = this;
        //Adjust the Edit Delete buttons accordingly...
